...
<Info>
  The Voice Agent API is available on the EU endpoint at `wss://api.eu.deepgram.com/v1/agent/converse`. See [Configuring Custom Endpoints](/reference/custom-endpoints) for details.
</Info>
...
<Info>
  Java users: the steps below cover Python, JavaScript, C#, and Go. For a complete Java implementation, see the [Java SDK Voice Agent example](https://github.com/deepgram/deepgram-java-sdk/blob/main/examples/agent/VoiceAgent.java).
</Info>
...
| Voice agent basic demo | Java | [Java SDK Voice Agent Example](https://github.com/deepgram/deepgram-java-sdk/blob/main/examples/agent/VoiceAgent.java) |
